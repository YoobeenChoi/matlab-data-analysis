...
raw_data = readtable('id_100817_unreal.xlsx');
...
% Find Button2 events between the second OCP_on and OCP_off for Lap 9
button_a_idx_9 = find(strcmp(raw_data.Var1(start_idx_9:end_idx_9), 'Button_2')) + start_idx_9 - 1;
...
for i = 1:length(button_a_idx_0)
    button_a_time = str2double(raw_data.Var2(button_a_idx_0(i)));  % Get the ButtonA time
